...
export declare function functionProp<Prop, Payload>(prop: Prop, payload?: Payload): Prop extends (...args: any) => any ? ReturnType<Prop> : Prop;
export declare function makePropsWithDefaults<Result extends Object>(props: Partial<Result>, defaultProps: Result): Result;
